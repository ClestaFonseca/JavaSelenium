...
public class Assignment2Forms {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		// driver.findElement(By.cssSelector("input[name='name']")).sendKeys("Clesta
		// Fonseca");
		// driver.findElement(By.cssSelector("input.form-control ng-pristine ng-invalid
		// ng-touched")).sendKeys("Clesta");
		...
		// 'exampleFormControlSelect1']/option[2]")).click();
